...
export class GestionPacientesComponent implements OnInit {
    ...
    private agregarPacientesEjemplo(): void {
        ...
        // persistir como usuarios (fallback local)
    ...
    guardarPaciente(): void {
            ...
            // Validación adicional por si el required del form no se aplica
    ...
    private mapPacienteToVM(p: Paciente): PacienteVM {
        return {
            ...
            email: p.persona?.usuario?.correo || '',
...
// Modelo de vista para la tabla y formularios
